...
class LocAnimEncoder : MessageEncoder<LocAnimMessage>() {
    override fun extract(message: LocAnimMessage, key: String): Number = when (key) {
    ...
    override fun extractBytes(message: LocAnimMessage, key: String): ByteArray = throw Exception("Unhandled value key.")
}