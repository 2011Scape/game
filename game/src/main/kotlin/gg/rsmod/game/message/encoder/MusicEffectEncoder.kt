...
class MusicEffectEncoder : MessageEncoder<MusicEffectMessage>() {
    ...
    override fun extract(message: MusicEffectMessage, key: String): Number = when (key) {
        "id" -> message.id
    ...
    override fun extractBytes(message: MusicEffectMessage, key: String): ByteArray = throw Exception("Unhandled value key.")
}