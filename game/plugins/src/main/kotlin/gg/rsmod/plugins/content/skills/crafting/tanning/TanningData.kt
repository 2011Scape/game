...
enum class TanningData(val componentId: Int, val price: Int, val rawItemId: Int, val tannedId: Int) {
    ...
    GREEN_DRAGONHIDE(componentId = 5, price = 20, rawItemId = Items.GREEN_DRAGONHIDE, tannedId = Items.GREEN_DRAGON_LEATHER),
    BLUE_DRAGONHIDE(componentId = 6, price = 20, rawItemId = Items.BLUE_DRAGONHIDE, tannedId = Items.BLUE_DRAGON_LEATHER),
    RED_DRAGONHIDE(componentId = 7, price = 20, rawItemId = Items.RED_DRAGONHIDE, tannedId = Items.RED_DRAGON_LEATHER),
    BLACK_DRAGONHIDE(componentId = 8, price = 20, rawItemId = Items.BLACK_DRAGONHIDE, tannedId = Items.BLACK_DRAGON_LEATHER);
