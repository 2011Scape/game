...
class FarmerDialogue(private val farmer: Farmer) {
                    ...
                    1 -> {
                        if (!patchManager.hasEnoughItemsToProtect()) {
                            ...
                            if (patchManager.protect()) {
                                chatNpc(*"Thank you, that will do. I will look after your crops for you.".splitForDialogue())
                            } else {
                ...
                when (it.options("Ok.", "No thank you.")) {
                    1 -> {
                        if (!patchManager.hasEnoughItemsToProtect()) {
                            ...
                            if (patchManager.protect()) {
                                it.chatNpc(*"Thank you, that will do. I will look after your crops for you.".splitForDialogue())
                            } else {
