...
enum class Emote(
    ...
    BLOW_KISS(component = 19, anim = Anims.EMOTE_BLOW_KISS, gfx = Gfx.EMOTE_BLOW_KISS),
    ...
    IDEA(component = 33, anim = Anims.EMOTE_IDEA, gfx = Gfx.EMOTE_IDEA, varbit = EmotesTab.IDEA_EMOTE_VARBIT),
    ...
    ZOMBIE_HAND(component = 36, anim = Anims.EMOTE_ZOMBIE_HAND, gfx = Gfx.EMOTE_ZOMBIE_HAND, varbit = EmotesTab
        .ZOMBIE_HAND_EMOTE_VARBIT),
    ...
    AIR_GUITAR(component = 41, anim = Anims.EMOTE_AIR_GUITAR, gfx = Gfx.EMOTE_AIR_GUITAR, varbit = EmotesTab.AIR_GUITAR_EMOTE_VARBIT),
    SAFETY_FIRST(component = 42, anim = Anims.EMOTE_SAFETY_FIRST, gfx = Gfx.EMOTE_SAFETY_FIRST, varbit = EmotesTab.SAFETY_FIRST_EMOTE_VARBIT),
    EXPLORE(component = 43, anim = Anims.EMOTE_EXPLORE, gfx = Gfx.EMOTE_EXPLORE, varbit = EmotesTab.EXPLORE_EMOTE_VARBIT),
    TRICK(component = 44, anim = Anims.EMOTE_TRICK, gfx = Gfx.EMOTE_TRICK, varbit = EmotesTab.TRICK_EMOTE_VARBIT),
    FREEZE(component = 45, anim = Anims.EMOTE_FREEZE, gfx = Gfx.EMOTE_FREEZE, varbit = EmotesTab.FREEZE_EMOTE_VARBIT),
    GIVE_THANKS(component = 46, anim = Anims.RESET, varbit = EmotesTab.GIVE_THANKS_EMOTE_VARBIT),
    AROUND_THE_WORLD(
        component = 47,
        anim = Anims.EMOTE_AROUND_THE_WORLD,
        gfx = Gfx.EMOTE_AROUND_THE_WORLD,
        varbit = EmotesTab.AROUND_THE_WORLD_EMOTE_VARBIT,
        requiredVarbitValue = 85,
    ),
    DRAMATIC_POINT(component = 48, anim = Anims.EMOTE_DRAMATIC_POINT, gfx = Gfx.EMOTE_DRAMATIC_POINT, varbit = EmotesTab.DRAMATIC_POINT_EMOTE_VARBIT),
    FAINT(component = 49, anim = Anims.EMOTE_FAINT, varbit = EmotesTab.FAINT_EMOTE_VARBIT),
    PUPPET_MASTER(
        component = 50,
        anim = Anims.EMOTE_PUPPET_MASTER,
        gfx = Gfx.EMOTE_PUPPET_MASTER,
