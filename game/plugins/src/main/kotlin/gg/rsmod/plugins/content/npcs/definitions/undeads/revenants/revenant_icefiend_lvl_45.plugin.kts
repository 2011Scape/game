...
on_npc_spawn(id) {
    npc.animate(Anims.REVENANT_ICEFIEND_SPAWN)
}
...
set_combat_def(id) {
    ...
    anims {
        attack = Anims.REVENANT_ICEFIEND_MELEE_ATTACK
        block = Anims.REVENANT_ICEFIEND_BLOCK
        death = Anims.REVENANT_ICEFIEND_DEATH
    }
    aggro {
        radius = 5
    }
