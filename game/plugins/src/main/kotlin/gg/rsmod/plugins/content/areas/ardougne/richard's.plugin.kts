...
create_shop("Richard's Farming Store", CoinCurrency(), containsSamples = false, purchasePolicy = PurchasePolicy.BUY_TRADEABLES) {
    var index = 0
...
on_npc_option(npc = Npcs.RICHARD, option = "talk-to") {
    player.queue {
        ...
        when (this.options("What are you selling?", "Can you give me any Farming advice?", "I'm okay, thank you.")) {
            1 -> player.openShop("Richard's Farming Store")
