...
create_shop("Happy Heroes' H'emporium", CoinCurrency(), containsSamples = false, purchasePolicy = PurchasePolicy.BUY_STOCK) {
...
suspend fun mainChat(it: QueueTask, player: Player) {
    ...
    when (it.options(
        ...
        SECOND_OPTION -> {
            ...
            it.chatNpc("Look around... there are all sorts of things to keep our guild members entertained!", wrap = true)
        }
    }
}
