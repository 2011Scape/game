...
suspend fun chat(it: QueueTask) {
    ...
    it.chatNpc("There is nothing you need to do my friend! I am the", "Doomsayer, although my real titel should be " +
        "something", "like the Danger Tutor.")
    it.chatPlayer("Danger Tutor?", facialExpression = FacialExpression.CONFUSED)
    it.chatNpc("Yes! I roam the world sensing danger.")
    it.chatNpc("If I find a dangerous area, then I put up warning", "signs that will tell you what is so dangerous " +
        "about that", "area.")
    it.chatNpc("If you see the signs often enough, then you can turn", "them off, by that time you likely know what " +
