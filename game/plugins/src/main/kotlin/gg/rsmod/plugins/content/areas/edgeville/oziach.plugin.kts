...
suspend fun afterDragonSlayerDialogue(it: QueueTask) {
    ...
    when (it.options("Can I buy a rune platebody now, please?", "I'm not your friend.", "Yes, it's a very nice day.", "Can I have another key to Melzar's Maze?")) {
        FIRST_OPTION -> {
        ...
        FOURTH_OPTION -> {
            ...
            it.chatNpc("It's the Guildmaster in the Champion's Guild who hands those keys out now.",
...
suspend fun carryingDraconicVisageDialogue(it: QueueTask) {
    ...
    when (it.options("Can I buy a rune platebody now, please?", "I'm not your friend.", "Yes, it's a very nice day.", "Can I have another key to Melzar's Maze?", "Here you go.")) {
        FIRST_OPTION -> {
            it.chatPlayer("Can I buy a rune platebody now please?")
            it.player.openShop("Oziach's Armour")
        }
            ...
            it.chatNpc("What d'ye say?")
                when (it.options("Yes, please!", "No, thanks.", "That's a bit expensive!")) {
                    ...
                    THIRD_OPTION -> {
                        ...
                        it.chatNpc("Yes it is. But I'm a master smith so I reckon I can charge what I like.",
                        ...
                        if (it.player.skills.getMaxLevel(Skills.SMITHING) < 90) {
                            ...
                            it.chatNpc("I thought not. I'm the master smith of Misthalin! So, shall I construct the shield for you?")
                        } else {
                ...
                it.chatNpc("Now, if ye bring me this and the anti-dragonbreath shield,",
