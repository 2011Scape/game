...
enum class FeatheringData(
    val product: Int,
    val raw: Int,
    val amount: Int = 10,
    val feathersRequired: Int = 1,
    val levelRequirement: Int,
    val experience: Double,
) {
    HEADLESS_ARROW(
        product = Items.HEADLESS_ARROW,
        raw = Items.ARROW_SHAFT,
        amount = 15,
        levelRequirement = 1,
        experience = 1.0,
    ),
    FLIGHTED_OGRE_ARROW(
        product = Items.FLIGHTED_OGRE_ARROW,
        raw = Items.OGRE_ARROW_SHAFT,
        amount = 6,
        feathersRequired = 4,
        levelRequirement = 1,
        experience = 0.9,
    ...
    BLURITE_BOLTS(
        product = Items.BLURITE_BOLTS,
        raw = Items.BLURITE_BOLTS_UNF,
        levelRequirement = 24,
        experience = 1.0,
    ),
    ...
    MITHRIL_BOLTS(
        product = Items.MITHRIL_BOLTS,
        raw = Items.MITHRIL_BOLTS_UNF,
        levelRequirement = 54,
        experience = 5.0,
    ),
    BROAD_BOLTS(
        product = Items.BROADTIPPED_BOLTS,
        raw = Items.UNFINISHED_BROAD_BOLTS,
        levelRequirement = 55,
        experience = 3.0,
    ),
    ADAMANT_BOLTS(
        product = Items.ADAMANT_BOLTS,
        raw = Items.ADAMANT_BOLTS_UNF,
        levelRequirement = 61,
        experience = 7.0,
    ),
