...
object RuneMysteries : Quest(
    ...
    override fun finishQuest(player: Player) {
        ...
        player.buildQuestFinish(this, item = Items.AIR_TALISMAN, rewards = arrayOf("1 Quest Point", "Introduction to the", "Runecrafting skill and rune", "essence mine", "Air talisman"))
    }
}