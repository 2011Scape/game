...
enum class LightSource(val raw: Int, val product: Int, val levelRequired: Int, val enclosed: Boolean, val interfaceId: Int) {
    ...
    BULLSEYE_LANTERN(raw = Items.BULLSEYE_LANTERN_4548, product = Items.BULLSEYE_LANTERN_4550, levelRequired = 49, enclosed = false, interfaceId = 98),
    SAPPHIRE_LANTERN(raw = Items.SAPPHIRE_LANTERN_4701, product = Items.SAPPHIRE_LANTERN_4702, levelRequired = 49, enclosed = false, interfaceId = 98),
    ...
    MINING_HELMET(raw = Items.MINING_HELMET_5014, product = Items.MINING_HELMET, levelRequired = 65, enclosed = false, interfaceId = 98);
