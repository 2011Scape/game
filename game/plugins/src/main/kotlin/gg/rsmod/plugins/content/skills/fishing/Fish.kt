...
enum class Fish(
    ...
    LEAPING_TROUT(id = Items.LEAPING_TROUT, level = 48, minChance = 32, maxChance = 192, xp = 50.0, strengthLevel = 15, strengthXp = 5.0, agilityLevel = 15, agilityXp = 5.0),
    LEAPING_SALMON(id = Items.LEAPING_SALMON, level = 58, minChance = 16, maxChance = 96, xp = 70.0, strengthLevel = 30, strengthXp = 6.0, agilityLevel = 30, agilityXp = 6.0),
    LEAPING_STURGEON(id = Items.LEAPING_STURGEON, level = 70, minChance = 8, maxChance = 64, xp = 90.0, strengthLevel = 45, strengthXp = 7.0, agilityLevel = 45, agilityXp = 7.0),
