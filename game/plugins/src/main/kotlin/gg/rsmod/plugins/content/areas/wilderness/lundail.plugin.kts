...
create_shop("Lundail's Arena-side Rune Shop", currency = CoinCurrency(), purchasePolicy = PurchasePolicy.BUY_STOCK, containsSamples = false) {
...
suspend fun whatAreYouSelling(it: QueueTask) {
    ...
    it.chatNpc("I sell rune stones. I've got some good stuff,",
...
suspend fun whatsThatBigOldBuilding(it: QueueTask) {
    ...
    it.chatNpc("That, my friend, is the mage battle arena.",
