...
enum class BowType(val item: Int, val ammo: Array<Int>) {
    ...
    WILLOW_COMP_BOW(item = Items.WILLOW_COMPOSITE_BOW, ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS),
    ...
    YEW_COMP_BOW(item = Items.YEW_COMPOSITE_BOW, ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS),

    MAGIC_SHORTBOW(item = Items.MAGIC_SHORTBOW, ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + BROAD_ARROWS),
    MAGIC_LONGBOW(item = Items.MAGIC_LONGBOW, ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + BROAD_ARROWS),
    MAGIC_COMP_BOW(item = Items.MAGIC_COMPOSITE_BOW, ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + BROAD_ARROWS),

    SEERCULL(item = Items.SEERCULL, ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + BROAD_ARROWS),

    DARK_BOW(item = Items.DARK_BOW, ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + DRAGON_ARROWS + BROAD_ARROWS),
    BLUE_DARK_BOW(item = Items.DARK_BOW_15701, ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + DRAGON_ARROWS + BROAD_ARROWS),
    GREEN_DARK_BOW(item = Items.DARK_BOW_15702, ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + DRAGON_ARROWS + BROAD_ARROWS),
    WHITE_DARK_BOW(item = Items.DARK_BOW_15703, ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + DRAGON_ARROWS + BROAD_ARROWS),
    YELLOW_DARK_BOW(item = Items.DARK_BOW_15704, ammo = BRONZE_ARROWS + IRON_ARROWS + STEEL_ARROWS + MITHRIL_ARROWS + ADAMANT_ARROWS + RUNE_ARROWS + DRAGON_ARROWS + BROAD_ARROWS),
