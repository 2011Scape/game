...
enum class CharterType(
    ...
    ARDOUGNE_TO_BRIMHAVEN(varpValue = 7, npcIds = arrayOf(Npcs.CUSTOMS_OFFICER), delay = 5),
    BRIMHAVEN_TO_ARDOUGNE(varpValue = 8, npcIds = arrayOf(Npcs.CUSTOMS_OFFICER), delay = 5),
