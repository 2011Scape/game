...
val white_knight = table.build {
    ...
    main {
        ...
        obj(Items.MIND_RUNE, quantity = 10, slots = 8)
        obj(Items.NATURE_RUNE, quantity = 6, slots = 4)
        obj(Items.BODY_RUNE, quantityRange = 15..19, slots = 3)
        obj(Items.CHAOS_RUNE, quantity = 4, slots = 3)
        obj(Items.WATER_RUNE, quantityRange = 35..40, slots = 3)
        obj(Items.MITHRIL_ARROW, quantity = 7, slots = 5)
        obj(Items.ADAMANT_ARROW, quantity = 4, slots = 3)
        obj(Items.BLOOD_RUNE, quantity = 3, slots = 1)
        obj(Items.LAW_RUNE, quantity = 3, slots = 1)
        obj(Items.COINS_995, quantityRange = 15..19, slots = 13)
        obj(Items.COINS_995, quantity = 15, slots = 10)
        obj(Items.COINS_995, quantityRange = 55..63, slots = 10)
        obj(Items.COINS_995, quantityRange = 50..69, slots = 10)
        obj(Items.COINS_995, quantity = 5, slots = 6)
        obj(Items.COINS_995, quantity = 120, slots = 2)
