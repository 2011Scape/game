...
object FlowerProtection {
    val protections = mapOf(
        ...
        Seed.Scarecrow to listOf(Seed.Potato, Seed.Onion, Seed.Tomato, Seed.Cabbage, Seed.Sweetcorn, Seed.Strawberry, Seed.Watermelon),
    )

    val allotmentLinks = mapOf(
