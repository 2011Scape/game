...
enum class CookingData(
    ...
    CRAYFISH(
        raw = Items.RAW_CRAYFISH,
        cooked = Items.CRAYFISH,
        burnt = Items.BURNT_CRAYFISH,
        levelRequirement = 1,
        experience = 30.0,
        lowChance = 128,
        highChance = 512,
    ...
    SEA_TURTLE(
        raw = Items.RAW_SEA_TURTLE,
        cooked = Items.SEA_TURTLE,
        burnt = Items.BURNT_SEA_TURTLE,
        levelRequirement = 82,
        experience = 211.3,
        lowChance = 1,
        highChance = 222,
    ...
    MANTA_RAY(
        raw = Items.RAW_MANTA_RAY,
        cooked = Items.MANTA_RAY,
        burnt = Items.BURNT_MANTA_RAY,
        levelRequirement = 91,
        experience = 216.3,
        lowChance = 1,
        highChance = 222,
    ...
    CAVEFISH(
        ...
        cooked = Items.CAVEFISH,
        burnt = Items.BURNT_CAVEFISH,
        levelRequirement = 88,
        experience = 214.0,
        lowChance = 1,
        highChance = 232,
    ...
    RAINBOW_FISH(
        raw = Items.RAW_RAINBOW_FISH,
        cooked = Items.RAINBOW_FISH,
    ...
    THIN_SNAIL(
        raw = Items.THIN_SNAIL,
        cooked = Items.THIN_SNAIL_MEAT,
    ...
    LEAN_SNAIL(
        raw = Items.LEAN_SNAIL,
        cooked = Items.LEAN_SNAIL_MEAT,
        burnt = Items.BURNT_SNAIL,
        levelRequirement = 17,
        experience = 80.0,
        lowChance = 93,
