...
suspend fun kolodionDialogue(it: QueueTask) {
    ...
    it.chatNpc("I am the great Kolodion, master of battle magic,",
...
suspend fun mageArenaCompletedDialogue(it: QueueTask) {
    ...
    it.chatNpc("Well done, young adventurer;",
                        "you truly are a worthy battle mage.")
    it.chatPlayer("What now?")
    it.chatNpc("Step into the magic pool.",
...
suspend fun canIFightHere(it: QueueTask) {
    ...
    it.chatNpc("My arena is open to any high level wizard, but this",
...
suspend fun yesIndeedy(it: QueueTask) {
    ...
    it.chatNpc("Remember, traveller - in my arena, hand-to-hand combat",
...
suspend fun okayLetsFight(it: QueueTask) {
    ...
    it.chatNpc("Not just any magician can enter - only the most powerful",
...
suspend fun whatsThePoint(it: QueueTask) {
    ...
    it.chatNpc("We learn how to use our magic to its fullest and how",
...
suspend fun thatsBarbaric(it: QueueTask) {
    ...
    it.chatNpc("Nope, it's magic. But I know what you mean.",
