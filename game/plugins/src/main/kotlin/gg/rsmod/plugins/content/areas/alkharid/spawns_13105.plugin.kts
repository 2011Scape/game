...
spawn_npc(npc = Npcs.ALKHARID_WARRIOR, x = 3282, z = 3176, walkRadius = 3, direction = Direction.NORTH_WEST)
spawn_npc(npc = Npcs.ALKHARID_WARRIOR, x = 3284, z = 3170, walkRadius = 3, direction = Direction.SOUTH_EAST)
spawn_npc(npc = Npcs.ALKHARID_WARRIOR, x = 3284, z = 3174, walkRadius = 3, direction = Direction.NORTH_WEST)
spawn_npc(npc = Npcs.ALKHARID_WARRIOR, x = 3288, z = 3168, walkRadius = 3, direction = Direction.SOUTH_WEST)
spawn_npc(npc = Npcs.ALKHARID_WARRIOR, x = 3292, z = 3169, walkRadius = 3, direction = Direction.WEST)
...
spawn_npc(npc = Npcs.LOUIE_LEGS, x = 3316, z = 3175, walkRadius = 2, direction = Direction.WEST)
spawn_npc(npc = Npcs.KARIM, x = 3272, z = 3182, walkRadius = 2, direction = Direction.SOUTH)
spawn_npc(npc = Npcs.RANAEL, x = 3316, z = 3164, walkRadius = 2, direction = Direction.WEST)
...
spawn_item(item = Items.BODY_RUNE, amount = 1, x = 3290, z = 3191, height = 1)