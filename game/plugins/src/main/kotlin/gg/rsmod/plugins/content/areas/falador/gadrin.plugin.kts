...
suspend fun mainChat(it: QueueTask) {
    ...
    when (it.options(
        ...
        FIRST_OPTION -> {
            ...
            it.chatNpc("All sorts of things! There's plenty of coal rocks along with some iron, mithril and " +
                    "adamantite as well.", wrap = true)
        ...
        SECOND_OPTION -> {
            ...
            when (it.options(
                ...
                FIRST_OPTION -> {
                    it.chatPlayer("What have you got in the guild?")
                    it.chatNpc("All sorts of things! There's plenty of coal rocks along with some iron," +
                            " mithril and adamantite as well.", wrap = true)
                    it.chatNpc("There's no better mining site anywhere!")
                }
        ...
        THIRD_OPTION -> {
            ...
            it.chatNpc("Sure, this is a Skillcape of Mining. It shows my stature as a master miner! It has all" +
                    " sorts of uses including a skill boost to my Mining skill and a chance of mining extra ores.", wrap = true)
    ...
    when (it.options(
        ...
        SECOND_OPTION -> {
            ...
            when (it.options(
                ...
                FIRST_OPTION -> {
                    it.chatPlayer("What have you got in the guild?")
                    it.chatNpc("All sorts of things! There's plenty of coal rocks along with some iron, mithril " +
                            "and adamantite as well.", wrap = true)
                    it.chatNpc("There's no better mining site anywhere!")
                }
        ...
        THIRD_OPTION -> {
            it.chatPlayer("I believe I can buy a Skillcape of Mining from you?", facialExpression = FacialExpression.UNCERTAIN)
            it.chatNpc("You believe right, miner. You have earned the right to",
