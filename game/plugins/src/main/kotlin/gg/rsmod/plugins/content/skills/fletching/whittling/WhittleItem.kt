...
enum class WhittleItem(
    ...
    ARROW_SHAFT_15(
        product = Items.ARROW_SHAFT,
        amount = 15,
        levelRequirement = 1,
        experience = 5.0,
        itemName = "Arrow shafts<br>(Set of 15)",
    ),
    ...
    OGRE_ARROW_SHAFT(
        product = Items.OGRE_ARROW_SHAFT,
        levelRequirement = 5,
        experience = 1.6,
        itemName = "Ogre arrow shaft<br>(Set of 15)",
    ),
    UNSTRUNG_COMP_BOW(
    ...
    MAHOGANY_STOCK(
        product = Items.MAHOGANY_STOCK,
        levelRequirement = 61,
        experience = 41.0,
        itemName = "Crossbow Stock",
    ),
