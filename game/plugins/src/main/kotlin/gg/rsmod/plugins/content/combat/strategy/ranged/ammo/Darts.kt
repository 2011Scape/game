...
object Darts {
    ...
    val MITHRIL_DARTS =
        arrayOf(Items.MITHRIL_DART, Items.MITHRIL_DART_P, Items.MITHRIL_DART_P_5632, Items.MITHRIL_DART_P_5639)
    val ADAMANT_DARTS =
        arrayOf(Items.ADAMANT_DART, Items.ADAMANT_DART_P, Items.ADAMANT_DART_P_5633, Items.ADAMANT_DART_P_5640)
    val RUNE_DARTS = arrayOf(Items.RUNE_DART, Items.RUNE_DART_P, Items.RUNE_DART_P_5634, Items.RUNE_DART_P_5641)
    val DRAGON_DARTS =
