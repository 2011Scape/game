...
on_item_on_item(item1 = Items.GLASSBLOWING_PIPE, item2 = Items.MOLTEN_GLASS) {
    ...
    player.queue {
        produceItemBox(*products, option = SkillDialogueOption.MAKE, title = "Choose how many you wish to make,<br>then click on the item to begin.", names = itemNames, extraNames = levels, logic = ::glassBlow)
    }
}
