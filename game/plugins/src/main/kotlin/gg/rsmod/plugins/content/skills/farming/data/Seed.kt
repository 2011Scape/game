...
//    ), // TODO: can't find the varbits for diseased/died/watered
    ...
    Willow(
            ...
            SeedPlant(level = 30, plantXp = 25.0, plantedVarbit = 15, baseLives = 0),
    ...
    Maple(
            ...
            SeedPlant(level = 45, plantXp = 45.0, plantedVarbit = 24, baseLives = 0),
    ...
    Yew(
            ...
            SeedPlant(level = 60, plantXp = 81.0, plantedVarbit = 35, baseLives = 0),
    ...
    Magic(
            ...
            SeedPlant(level = 75, plantXp = 145.5, plantedVarbit = 48, baseLives = 0),
