...
enum class Seed(
    ...
    Guam(
            ...
            SeedHarvest(harvestXp = 12.5, minLiveSaveBaseSlots = 24, maxLiveSaveBaseSlots = 80)
    ),
    Marrentill(
            ...
            SeedHarvest(harvestXp = 15.0, minLiveSaveBaseSlots = 28, maxLiveSaveBaseSlots = 80)
    ),
    Tarromin(
            ...
            SeedHarvest(harvestXp = 18.0, minLiveSaveBaseSlots = 31, maxLiveSaveBaseSlots = 80)
    ),
    Harralander(
            ...
            SeedHarvest(harvestXp = 24.0, minLiveSaveBaseSlots = 36, maxLiveSaveBaseSlots = 80)
    ),
    Ranarr(
            ...
            SeedHarvest(harvestXp = 30.5, minLiveSaveBaseSlots = 39, maxLiveSaveBaseSlots = 80)
    ),
    SpiritWeed(
            ...
            SeedHarvest(harvestXp = 36.0, minLiveSaveBaseSlots = 43, maxLiveSaveBaseSlots = 80)
    ),
    Toadflax(
            ...
            SeedHarvest(harvestXp = 38.5, minLiveSaveBaseSlots = 43, maxLiveSaveBaseSlots = 80)
    ),
    Irit(
            ...
            SeedHarvest(harvestXp = 48.5, minLiveSaveBaseSlots = 46, maxLiveSaveBaseSlots = 80)
    ),
    Avantoe(
            ...
            SeedHarvest(harvestXp = 61.5, minLiveSaveBaseSlots = 50, maxLiveSaveBaseSlots = 80)
    ),
    Kwuarm(
            ...
            SeedHarvest(harvestXp = 78.0, minLiveSaveBaseSlots = 54, maxLiveSaveBaseSlots = 80)
    ),
    Snapdragon(
            ...
            SeedHarvest(harvestXp = 98.5, minLiveSaveBaseSlots = 57, maxLiveSaveBaseSlots = 80)
    ),
    Cadantine(
            ...
            SeedHarvest(harvestXp = 120.0, minLiveSaveBaseSlots = 60, maxLiveSaveBaseSlots = 80)
    ),
    Lantadyme(
            ...
            SeedHarvest(harvestXp = 151.5, minLiveSaveBaseSlots = 64, maxLiveSaveBaseSlots = 80)
    ),
    DwarfWeed(
            ...
            SeedHarvest(harvestXp = 192.0, minLiveSaveBaseSlots = 67, maxLiveSaveBaseSlots = 80)
    ),
    Torstol(
            ...
            SeedHarvest(harvestXp = 224.5, minLiveSaveBaseSlots = 71, maxLiveSaveBaseSlots = 80)
    ),
    ...
    Marigold(
            ...
            SeedHarvest(harvestXp = 47.0, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1)
    ),
    Rosemary(
            ...
            SeedHarvest(harvestXp = 66.5, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1)
    ),
    Nasturtium(
            ...
            SeedHarvest(harvestXp = 111.0, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1)
    ),
    WoadSeed(
            ...
            SeedHarvest(harvestXp = 115.5, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1)
    ),
    Limpwurt(
            ...
            SeedHarvest(harvestXp = 120.0, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1)
    ),
    Scarecrow(
            ...
            SeedHarvest(harvestXp = 0.0, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1)
    ),
//    WhiteLily(
...
//    ), // TODO: can't find the varbits for diseased/died/watered
    ...
    Potato(
            ...
            SeedHarvest(harvestXp = 9.0, minLiveSaveBaseSlots = 130, maxLiveSaveBaseSlots = 200)
    ),
    Onion(
            ...
            SeedHarvest(harvestXp = 10.5, minLiveSaveBaseSlots = 130, maxLiveSaveBaseSlots = 200)
    ),
    Cabbage(
            ...
            SeedHarvest(harvestXp = 11.5, minLiveSaveBaseSlots = 130, maxLiveSaveBaseSlots = 200)
    ),
    Tomato(
            ...
            SeedHarvest(harvestXp = 14.0, minLiveSaveBaseSlots = 130, maxLiveSaveBaseSlots = 200)
    ),
    Sweetcorn(
            ...
            SeedHarvest(harvestXp = 19.0, minLiveSaveBaseSlots = 130, maxLiveSaveBaseSlots = 200)
    ),
    Strawberry(
            ...
            SeedHarvest(harvestXp = 29.0, minLiveSaveBaseSlots = 130, maxLiveSaveBaseSlots = 200)
    ),
    Watermelon(
            ...
            SeedHarvest(harvestXp = 54.5, minLiveSaveBaseSlots = 130, maxLiveSaveBaseSlots = 200)
    ),
    ...
    Barley(
            ...
            SeedHarvest(harvestXp = 9.5, minLiveSaveBaseSlots = 100, maxLiveSaveBaseSlots = 180)
    ),
    Hammerstone(
            ...
            SeedHarvest(harvestXp = 10.0, minLiveSaveBaseSlots = 100, maxLiveSaveBaseSlots = 180)
    ),
    Asgarnian(
            ...
            SeedHarvest(harvestXp = 12.0, minLiveSaveBaseSlots = 100, maxLiveSaveBaseSlots = 180)
    ),
    Jute(
            ...
            SeedHarvest(harvestXp = 14.5, minLiveSaveBaseSlots = 100, maxLiveSaveBaseSlots = 180)
    ),
    Yanillian(
            ...
            SeedHarvest(harvestXp = 16.0, minLiveSaveBaseSlots = 100, maxLiveSaveBaseSlots = 180)
    ),
    Krandorian(
            ...
            SeedHarvest(harvestXp = 19.5, minLiveSaveBaseSlots = 100, maxLiveSaveBaseSlots = 180)
    ),
    WildBlood(
            ...
            SeedHarvest(harvestXp = 26.0, minLiveSaveBaseSlots = 100, maxLiveSaveBaseSlots = 180)
    ),
    ...
    Redberry(
            ...
            SeedHarvest(harvestXp = 4.5, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1, healthCheckXp = 64.0, healthCheckVarbit = 250),
    ),
    Cadavaberry(
            ...
            SeedHarvest(harvestXp = 7.0, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1, healthCheckXp = 102.5, healthCheckVarbit = 251),
    ),
    Dwellberry(
            ...
            SeedHarvest(harvestXp = 12.0, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1, healthCheckXp = 177.5, healthCheckVarbit = 252),
    ),
    Jangerberry(
            ...
            SeedHarvest(harvestXp = 19.0, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1, healthCheckXp = 284.5, healthCheckVarbit = 253),
    ),
    Whiteberry(
            ...
            SeedHarvest(harvestXp = 29.0, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1, healthCheckXp = 437.5, healthCheckVarbit = 254),
    ),
    PoisonIvy(
            ...
            SeedHarvest(harvestXp = 45.0, minLiveSaveBaseSlots = -1, maxLiveSaveBaseSlots = -1, healthCheckXp = 675.0, healthCheckVarbit = 255),
    ),
    ;

    // empty bush: plantedVarbit + growthStages. 1 berry = empty + 1, 2 berries = empty + 2, etc. vol = empty + 4. Health check is later
