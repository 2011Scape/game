...
enum class SummoningPouchData(
    ...
    GIANT_CHINCHOMPA(arrayOf(Items.CHINCHOMPA_10033), Items.BLUE_CHARM, 84, 2.9, 225.2, Items.GIANT_CHINCHOMPA_POUCH, 29, Npcs.GIANT_CHINCHOMPA, 38, 59),
    ...
    PHOENIX(arrayOf(Items.PHOENIX_QUILL), Items.CRIMSON_CHARM, 165, 1.1, 301.0, Items.PHOENIX_POUCH, 72, Npcs.PHOENIX, 76, 121),
