...
val abyssalDemon =
    table.build {
        ...
        main {
            ...
            // RUNES
            obj(Items.AIR_RUNE, quantity = 1, slots = 64)
            obj(Items.BLOOD_RUNE, quantity = listOf(7, 50).random(), slots = 32)
            obj(Items.CHAOS_RUNE, quantity = 1, slots = 56)
            obj(Items.LAW_RUNE, quantity = listOf(3, 45).random(), slots = 32)
            obj(Items.DEATH_RUNE, quantity = 1, slots = 8)
            ...
            obj(Items.PURE_ESSENCE_NOTED, quantity = 1, slots = 41)
