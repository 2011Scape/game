...
val RING_OF_WEALTH = intArrayOf(
    Items.RING_OF_WEALTH_4, Items.RING_OF_WEALTH_3, Items.RING_OF_WEALTH_2, Items.RING_OF_WEALTH_1
)
...
on_equipment_option(item = Items.RING_OF_WEALTH, option = "Rub") {
    player.message("You will need to recharge your ring of wealth before you can use it again.", type = ChatMessageType.GAME_MESSAGE)
