...
val id = Npcs.REVENANT_HELLHOUND
...
val hellhound =
    table.build {
        main {
            ...
            // Least rare, but still rare 1/2.3k
...
on_npc_spawn(id) {
    npc.animate(Anims.REVENANT_HELLHOUND_SPAWN)
}
...
set_combat_def(id) {
    ...
    anims {
        attack = Anims.REVENANT_HELLHOUND_MELEE_ATTACK
        block = Anims.REVENANT_HELLHOUND_BLOCK
        death = Anims.REVENANT_HELLHOUND_DEATH
    }
    aggro {
        radius = 5
    }
