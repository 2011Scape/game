 ...
 */
enum class SmeltingData(val id: Int, val prefix: String, val primaryOre: Int, val secondaryOre: Int = Items.COAL, val secondaryCount: Int = 1, val level: Int, val smeltXp: Double, val smithXp: Double = 0.0) {
    ...
    ADAMANT(id = Items.ADAMANT_BAR, prefix = "adamant", primaryOre = Items.ADAMANTITE_ORE, secondaryCount = 6, level = 70, smeltXp = 37.5, smithXp = 62.5),
    RUNE(id = Items.RUNE_BAR, prefix = "rune", primaryOre = Items.RUNITE_ORE, secondaryCount = 8, level = 85, smeltXp = 50.0, smithXp = 75.0);
