...
enum class SeedType(
    ...
    Flower(
            ...
            Harvest(harvestingTool = Items.SPADE, fixedLives = true, harvestAnimation = 2292, livesReplenish = false, liveReplenishFrequency = null)
    ),
    Allotment(
            ...
            Harvest(harvestingTool = Items.SPADE, fixedLives = false, harvestAnimation = 830, livesReplenish = false, liveReplenishFrequency = null)
    ),
    Herb(
            Plant(amountToPlant = 1, plantingTool = PlantingTool.SeedDibber),
            Growth(growthFrequency = 4, canDiseaseOnFirstStage = false, cureType = CureType.Potion, canBeWatered = false),
            Harvest(harvestingTool = null, fixedLives = false, harvestAnimation = 2282, livesReplenish = false, liveReplenishFrequency = null)
    ),
    Hops(
    ...
    Bush(
            Plant(amountToPlant = 1, plantingTool = PlantingTool.SeedDibber),
            Growth(growthFrequency = 4, canDiseaseOnFirstStage = false, cureType = CureType.Potion, canBeWatered = false),
            Harvest(harvestingTool = null, fixedLives = true, harvestAnimation = 2281, livesReplenish = true, liveReplenishFrequency = 4)
    ),
    FruitTree(
    ...
    Tree(
            Plant(amountToPlant = 1, plantingTool = PlantingTool.Spade),
            Growth(growthFrequency = 8, canDiseaseOnFirstStage = false, cureType = CureType.Secateurs, canBeWatered = false),
            Harvest(harvestingTool = null, fixedLives = true, harvestAnimation = -1, livesReplenish = false, liveReplenishFrequency = null)
    ),
}
