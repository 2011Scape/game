...
enum class FishingSpot(
    ...
    NET_AND_BAIT(
        objectIds = listOf(Npcs.FISHING_SPOT_NET_BAIT, Npcs.FISHING_SPOT_316, Npcs.FISHING_SPOT_327, Npcs.FISHING_SPOT_1331, Npcs.FISHING_SPOT_7045),
        tools = listOf(FishingTool.SMALL_FISHING_NET, FishingTool.FISHING_ROD_SEA)
    ),
    LURE_AND_BAIT(
        objectIds = listOf(Npcs.FISHING_SPOT_LURE_BAIT, Npcs.FISHING_SPOT_311, Npcs.FISHING_SPOT_328, Npcs.FISHING_SPOT_315,Npcs.FISHING_SPOT_1189, Npcs.FISHING_SPOT_927, Npcs.FISHING_SPOT_309, Npcs.FISHING_SPOT_317),
        tools = listOf(FishingTool.FISHING_ROD_RIVER, FishingTool.FLY_FISHING_ROD)
    ),
    NET_HARPOON(
        objectIds = listOf(Npcs.FISHING_SPOT_NET_HARPOON, Npcs.FISHING_SPOT_1333, Npcs.FISHING_SPOT_7044, Npcs.FISHING_SPOT_5471, Npcs.FISHING_SPOT_1405,Npcs.FISHING_SPOT_1406),
        tools = listOf(FishingTool.BIG_FISHING_NET, FishingTool.HARPOON_SHARK)
    ),
    CAGE_AND_HARPOON(
        objectIds = listOf(Npcs.FISHING_SPOT_CAGE_HARPOON, Npcs.FISHING_SPOT_1332, Npcs.FISHING_SPOT_7046, Npcs.FISHING_SPOT_3804,Npcs.FISHING_SPOT_5470),
