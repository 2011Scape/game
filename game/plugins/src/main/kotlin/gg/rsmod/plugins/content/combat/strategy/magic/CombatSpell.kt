...
enum class CombatSpell(
    ...
    WIND_RUSH(
        ...
        castAnimation = arrayOf(Anims.SPELL_WIND, Anims.SPELL_WIND_WITH_STAFF),
        projectile = 458,
    ...
    WATER_STRIKE(
        ...
        castAnimation = arrayOf(Anims.SPELL_WATER, Anims.SPELL_WATER_WITH_STAFF),
        projectile = 2703,
    ...
    EARTH_STRIKE(
        ...
        castAnimation = arrayOf(Anims.SPELL_EARTH, Anims.SPELL_EARTH_WITH_STAFF),
        projectile = 2718,
    ...
    FIRE_STRIKE(
        ...
        castAnimation = arrayOf(Anims.SPELL_FIRE, Anims.SPELL_FIRE_WITH_STAFF),
        projectile = 2729,
