    ...
    player.queue {
        ...
        when (player.getCurrentStage(knightsSword)) {
            0 -> {
                when (options("And how is life as a squire?", "Wouldn't you prefer to be a squire for me?")) {
                    1 -> {
                        ...
                        chatNpc(*"Well, Sir Vyvin is a good guy to work for, however, I'm in a spot of trouble today. I've gone and lost Sir Vyvin's sword!".splitForDialogue())
                        when (options(
                            "Do you know where you lost it?", "I can make a new sword if you like...", "Is he angry?"
                        )) {
                            1 -> {
                                chatPlayer("Do you know where you lost it?")
                                chatNpc(*"Well now, if I knew THAT it wouldn't be lost, now would it?".splitForDialogue())
                                when (options(
                                    "Well, do you know the VAGUE AREA you lost it?",
                                    "I can make a new sword if you like..."
                                )) {
                                    1 -> sendCommonResponse(
                                        this, question = "Well, do you know the VAGUE AREA you lost it?"
                                    )
            ...
            4 -> { // Make player go find the portrait in the cupboard of Sir Vyvin's room
                chatNpc("So how are you doing getting a sword?")
                chatPlayer(*"I've found an Imcando dwarf but he needs a picture of the sword before he can make it.".splitForDialogue())
                chatNpc(*"A picture eh? Hmmm.... The only one I can think of is in a small portrait of Sir Vyvin's father... Sir Vyvin keeps it in a cupboard in his room I think.".splitForDialogue())
            ...
            6 -> { // If player comes back with the Blurite sword.
                if (player.inventory.contains(Items.BLURITE_SWORD)) {
                    ...
                    chatNpc(*"Thank you, thank you, thank you! I was seriously worried I would have to own up to Sir Vyvin!".splitForDialogue())
...
suspend fun sendCommonResponse(task: QueueTask, question: String) {
    when (question) {
        "I can make a new sword if you like..." -> {
            ...
            task.chatNpc(*"The thing is, this sword if a family heirloom. It has been passed down through Vyvin's family for five generations! It was originally made by the Imcando dwarves, who were".splitForDialogue())
            task.chatNpc(
                *"a particularly skilled tribe of dwarven smiths. I doubt anyone could make it in the style they do.".splitForDialogue()
            )
        ...
        "Well, I hope you find it soon.", "Well I hope you find it soon." -> {
            ...
            task.chatNpc(
                *"Yes, me too. I'm not looking forward to telling Vyvin I've lost it. He's going to want it for the parade next week as well.".splitForDialogue()
            )
        }
        ...
        "Well, the kingdom is fairly abundant with swords..." -> {
            ...
            task.chatNpc(
                *"The thing is, this sword if a family heirloom. It has been passed down through Vyvin's family for five generations! It was originally made by the Imcando dwarves, who were".splitForDialogue()
            )
            task.chatNpc(
                *"a particularly skilled tribe of dwarven smiths. I doubt anyone could make it in the style they do.".splitForDialogue()
            )
        ...
        "Is he angry", "Is he angry?" -> {
            ...
            task.chatNpc(
                *"He doesn't know yet. I was hoping I could think of something to do before he does find out, But I find myself at a loss.".splitForDialogue()
            )
            when (task.options(
                "Well, do you know the VAGUE AREA you lost it?",
                "I can make a new sword if you like...",
        ...
        "So would these dwarves make another one?" -> {
            ...
            task.chatNpc(
                *"I'm not a hundred percent sure the Imcando tribe exists anymore. I should think Reldo, the palace librarian in Varrock, will know; he has done a lot of research on the races of Gielinor.".splitForDialogue()
            )
            task.chatNpc(
                *"I don't suppose you could try and track down the Imcando dwarves for me? I've got so much work to do...".splitForDialogue()
            )
            when (task.options("Ok, I'll give it a go.", "No, I've got lots of mining work to do.")) {
                1 -> {
                    if (task.player.canStartQuest(knightsSword)) {
                        ...
                        task.chatNpc(
                            *"Thank you very much! As I say, the best place to start should be with Reldo...".splitForDialogue()
                        )
        ...
        "Well, do you know the VAGUE AREA you lost it?" -> {
            ...
            task.chatNpc(
                *"No. I was carrying it for him all the way from where he had it stored in Lumbridge. It must have slipped from my pack during the trip, and you know what people are like these days...".splitForDialogue()
            )
