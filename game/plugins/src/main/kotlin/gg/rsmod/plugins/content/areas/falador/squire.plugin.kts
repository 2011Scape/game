...
suspend fun sendCommonResponse(task: QueueTask, question: String) {
    when (question) {
        "I can make a new sword if you like..." -> {
            ...
            task.chatNpc(
                "The thing is, this sword if a family heirloom.",
                "It has been passed down through Vyvin's family",
                "for five generations! It was originally made by",
                "the Imcando dwarves, who were"
            )
            task.chatNpc(
        ...
        "Well, I hope you find it soon.", "Well I hope you find it soon." -> {
            ...
            task.chatNpc(
                "Yes, me too. I'm not looking forward to telling",
                "Vyvin I've lost it. He's going to want it",
                "for the parade next week as well."
            )
        }
        ...
        "Is he angry", "Is he angry?" -> {
            ...
            task.chatNpc(
                ...
                "something to do before he does find out,",
        ...
        "So would these dwarves make another one?" -> {
            ...
            task.chatNpc(
                ...
                "librarian in Varrock, will know; he has",
                "done a lot of research on the races of Gielinor."
            )
            task.chatNpc(
        ...
        "Well, do you know the VAGUE AREA you lost it?" -> {
            ...
            task.chatNpc(
                ...
                "had it stored in Lumbridge. It must have slipped from",
                "my pack during the trip, and you know what people",
                "are like these days..."
            )
