    ...
    player.queue {
        ...
        when (player.getCurrentStage(knightsSword)) {
            0 -> {
                when (options("And how is life as a squire?", "Wouldn't you prefer to be a squire for me?")) {
                    1 -> {
                        ...
                        chatNpc(message = "Well, Sir Vyvin is a good guy to work for, however, I'm in a spot of trouble today. I've gone and lost Sir Vyvin's sword!".splitForDialogue())
                        when (options("Do you know where you lost it?", "I can make a new sword if you like...", "Is he angry?")) {
                            1 -> {
                                chatPlayer("Do you know where you lost it?")
                                chatNpc(message = "Well now, if I knew THAT it wouldn't be lost, now would it?".splitForDialogue())
                                when (options("Well, do you know the VAGUE AREA you lost it?", "I can make a new sword if you like...")) {
                                    1 -> sendCommonResponse(this, question = "Well, do you know the VAGUE AREA you lost it?")
            ...
            1 -> { // When player has been sent to find Thurgo but hasn't gone yet.
                ...
                chatNpc(message = "Please try and find them quickly... I am scared Sir Vyvin will find out!".splitForDialogue())
            }
            4 -> { // Make player go find the portrait in the cupboard of Sir Vyvin's room
                chatNpc("So how are you doing getting a sword?")
                chatPlayer(message = "I've found an Imcando dwarf but he needs a picture of the sword before he can make it.".splitForDialogue())
                chatNpc(message = "A picture eh? Hmmm.... The only one I can think of is in a small portrait of Sir Vyvin's father... Sir Vyvin keeps it in a cupboard in his room I think.".splitForDialogue())
                chatPlayer("Ok, I'll try and get that then.")
                chatNpc(message = "Please don't let him catch you! He MUSTN'T know what happened!".splitForDialogue())
            ...
            5 -> { // If player has found the portrait or not.
                if (!player.inventory.contains(Items.PORTRAIT)) {
                    ...
                    chatNpc(message = "Please try and get it quickly... I am scared Sir Vyvin will find out!".splitForDialogue())
                } else {
                    chatNpc("So how are you doing getting a sword?")
            ...
            6 -> {
                if (player.inventory.contains(Items.BLURITE_SWORD)) {
                    ...
                    chatNpc(message = "Thank you, thank you, thank you! I was seriously worried I would have to own up to Sir Vyvin!".splitForDialogue())
...
suspend fun sendCommonResponse(task: QueueTask, question: String) {
    when (question) {
        "I can make a new sword if you like..." -> {
            task.chatPlayer("I can make a new sword if you like...")
            task.chatNpc("Thanks for the offer. I'd be surprised if you could though.")
            task.chatNpc("The thing is, this sword if a family heirloom.", "It has been passed down through Vyvin's family", "for five generations! It was originally made by", "the Imcando dwarves, who were")
            task.chatNpc("a particularly skilled tribe of dwarven smiths.", "I doubt anyone could make it in the style they do.")
        ...
        "Well, I hope you find it soon.", "Well I hope you find it soon." -> {
            ...
            task.chatNpc("Yes, me too. I'm not looking forward to telling", "Vyvin I've lost it. He's going to want it", "for the parade next week as well.")
        }
        "Well, the kingdom is fairly abundant with swords..." -> {
            task.chatPlayer("Well, the kingdom is fairly abundant with swords...")
            task.chatNpc("Yes, you can get bronze swords anywhere.", "But THIS isn't any old sword.")
            task.chatNpc("The thing is, this sword if a family heirloom.", "It has been passed down through Vyvin's family", "for five generations! It was originally made by", "the Imcando dwarves, who were")
            task.chatNpc("a particularly skilled tribe of dwarven smiths.", "I doubt anyone could make it in the style they do.")
            when (task.options("So would these dwarves make another one?", "Well I hope you find it soon.")) {
                1 -> sendCommonResponse(task, question = "So would these dwarves make another one?")
        ...
        "Is he angry", "Is he angry?" -> {
            ...
            task.chatNpc("He doesn't know yet. I was hoping I could think of", "something to do before he does find out,", "But I find myself at a loss.")
            when (task.options("Well, do you know the VAGUE AREA you lost it?", "I can make a new sword if you like...", "Well, the kingdom is fairly abundant with swords...", "Well, I hope you find it soon.")) {
        ...
        "So would these dwarves make another one?" -> {
            ...
            task.chatNpc("I'm not a hundred percent sure the Imcando tribe", "exists anymore. I should think Reldo, the palace", "librarian in Varrock, will know; he has", "done a lot of research on the races of Gielinor.")
            task.chatNpc("I don't suppose you could try and track down the", "Imcando dwarves for me? I've got so much work to do...")
            when (task.options("Ok, I'll give it a go.", "No, I've got lots of mining work to do.")) {
                1 -> {
                    if (task.player.canStartQuest(knightsSword)) {
                        ...
                        task.chatNpc(
                            "Thank you very much!",
                            "As I say, the best place to start should",
                            "be with Reldo..."
                        )
                        ...
                        task.messageBox("You need a Mining level of 10 to be able to start ${red("The Knight's Sword")}.")
                    }
                }
                2 -> {
        ...
        "Well, do you know the VAGUE AREA you lost it?" -> {
            ...
            task.chatNpc("No. I was carrying it for him all the way from where he", "had it stored in Lumbridge. It must have slipped from", "my pack during the trip, and you know what people","are like these days...")
            task.chatNpc("Someone will have just picked it up and kept it", "for themselves.")
            when (task.options("I can make a new sword if you like...", "Well, the kingdom is fairly abundant with swords...", "Well, I hope you find it soon.")) {
