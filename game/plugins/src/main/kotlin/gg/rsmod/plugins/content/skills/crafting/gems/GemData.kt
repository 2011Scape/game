...
enum class GemData(
    ...
    val animation: Int,
    val lowChance: Int = -1,
    val highChance: Int = -1,
) {
    OPAL(
        uncut = Items.UNCUT_OPAL,
        cut = Items.OPAL,
        experience = 15.0,
        levelRequirement = 1,
        animation = 886,
    ...
    DRAGONSTONE(
        uncut = Items.UNCUT_DRAGONSTONE,
        cut = Items.DRAGONSTONE,
        experience = 137.5,
        levelRequirement = 55,
        animation = 885,
    ),
