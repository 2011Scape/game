...
suspend fun mainChat(it: QueueTask) {
    ...
    when (it.options(
        ...
        FIRST_OPTION -> {
            ...
            it.chatNpc("This? This is a Skillcape of Crafting. It is a symbol of my ability as master of the" +
                    " Crafting Guild.", wrap = true)
            it.chatNpc("If you should ever achieve level 99 Crafting come and talk to me and we'll see if we can" +
                    " sort you out with one.", wrap = true)
        }
        SECOND_OPTION -> {
            return
        }
...
suspend fun mainChatWith99(it: QueueTask) {
    it.chatNpc(
        "Hello, and welcome to the Crafting Guild. Accomplished crafters from all over the land come here to use our top" +
                " notch workshops.", wrap = true)
    it.chatPlayer("Are you the person I should be talking to about buying a",
    ...
    it.chatNpc("Unfortunately, being such a prestigious item, they are appropriately expensive. I'm afraid I must" +
            " ask you for 99000 gold.", wrap = true)
    when (it.options(
        ...
        FIRST_OPTION -> {
            ...
            it.chatNpc(" Not at all; there are many other adventurers who would love the opportunity to purchase" +
                    " such a prestigious item! You can find me here if you change your mind.", wrap = true)
            return
        }
        SECOND_OPTION -> {
            ...
            if (it.player.inventory.freeSlotCount < 2) {
                it.chatNpc(
                    "Unfortunately all Skillcapes are only available with a free hood, it's part of a skill" +
                            ...
                            "space before I can sell you one.", wrap = true)
