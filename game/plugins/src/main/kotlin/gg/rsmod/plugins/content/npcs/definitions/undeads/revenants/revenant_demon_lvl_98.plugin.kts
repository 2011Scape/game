...
val demon =
    table.build {
        main {
            ...
            // Least rare, but still rare 1/2.1k
            ...
            val takenSlots = 1146
            val remaining = 98_145 - takenSlots
            obj(Items.COINS_995, quantityRange = 1..458, remaining)
        }
    }

table.register(demon, id)
...
on_npc_spawn(id) {
    npc.animate(Anims.REVENANT_DEMON_SPAWN)
}
...
set_combat_def(id) {
    ...
    anims {
        attack = Anims.REVENANT_DEMON_MELEE_ATTACK
        block = Anims.REVENANT_DEMON_BLOCK
        death = Anims.REVENANT_DEMON_DEATH
    }
    aggro {
        radius = 5
    }
