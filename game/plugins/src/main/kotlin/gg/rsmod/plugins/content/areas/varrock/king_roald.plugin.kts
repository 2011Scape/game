...
suspend fun kingRoaldDialogue(it: QueueTask) {
    ...
    it.chatNpc("A quest you say? Hmm, what an odd request to make",
                        "of the king. It's funny you should mention it though, as",
                        "there is something you can do for me.")
    it.chatNpc("Are you aware of the temple east of here? It stands on",
    ...
    it.chatNpc("Hmm, how strange that you don't. Well anyway, it has",
                        "been some days since last I heard from Drezel, the",
                        "priest who lives there.")
    it.chatNpc("Be a sport and go make sure that nothing untoward",
    ...
    it.chatNpc("Many thanks adventurer! I would have sent one of my",
...
suspend fun kingRoaldDialogueAfterAcceptingQuest(it: QueueTask) {
    ...
    when (it.options(
        ...
        4 -> {
            ...
            it.chatNpc("You will be rewarded in the knowledge that you have done the right thing and assisted the King of Misthalin.")
    ...
    suspend fun kingRoaldDialogueAfterAcceptingQuestButBeforeKillingTheDog(it: QueueTask) {
        ...
        it.chatNpc("Well hello there. What do you want?")
        it.chatNpc("You have news of Drezel for me?")
        it.chatPlayer("Well... I went to the temple like you asked me to",
            "... and I spoke to someone inside...")
        it.chatNpc("Ah, well that must have been Drezel then.",
            "What did he say?")
        it.chatPlayer("Well... he seemed to be having some kind of",
            "trouble with a dog...")
        it.chatNpc("I expect you to offer him your full assistance",
...
suspend fun kingRoaldDialogueAfterKillingTheDog(it: QueueTask) {
    ...
    it.chatNpc("Well hello there. What do you want?")
    it.chatNpc("You have news of Drezel for me?")
    it.chatPlayer("Yeah, I spoke to the guys at the temple and they said",
    ...
    it.chatNpc("Are you mentally deficient??? That guard dog was",
                "protecting the route to Morytania! Without it we could",
                "be in severe peril of attack!", facialExpression = FacialExpression.ANGRY)
    it.chatPlayer("Did I make a mistake?", facialExpression = FacialExpression.WORRIED)
    it.chatNpc("YES YOU DID!!!!! You need to get there right now",
            "and find out what is happening! Before it is too late for",
            "us all!", facialExpression = FacialExpression.ANGRY)
    it.chatPlayer("B-but Drezel TOLD me to...!", facialExpression = FacialExpression.SAD)
    it.chatNpc("No, you absolute cretin! Obviously some fiend has done",
            "something to Drezel and tricked your feeble intellect",
            "into helping them kill the guard dog!", facialExpression = FacialExpression.DISDAIN)
    it.chatNpc("You get back there and do whatever is necessary to",
            "safeguard my kingdom from attack, or I will se you",
            "beheaded for high treason!", facialExpression = FacialExpression.ANGRY)
