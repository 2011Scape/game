...
//grand exchange npc
spawn_npc(npc = Npcs.GRAND_EXCHANGE_CLERK, x = 3147, z = 3479, direction = Direction.WEST)
...
//bankers npc
spawn_npc(npc = Npcs.BANKER_LATEST_MALE_HANDSBEHIND_3416, x = 3149, z = 3480, direction = Direction.NORTH, static = true)
spawn_npc(npc = Npcs.BANKER_LATEST_FEMALE_HANDSBEHIND_3293, x = 3148, z = 3477, direction = Direction.SOUTH, static = true) // side split hair female facing south, southwest stall
spawn_npc(npc = Npcs.BANKER_LATEST_FEMALE_BLOND_HANDSBEHIND_2718, x = 3149, z = 3506, direction = Direction.NORTH, static = true) // blond female facing north, in nw stall
spawn_npc(npc = Npcs.BANKER_LATEST_MALE_HANDSBEHIND_3418, x = 3148, z = 3503, direction = Direction.SOUTH, static = true)
spawn_npc(npc = Npcs.BANKER_LATEST_FEMALE_HANDSBEHIND_3293, x = 3180, z = 3503, direction = Direction.SOUTH, static = true) // split hair female facing south, in north east stall
spawn_npc(npc = Npcs.BANKER_LATEST_MALE_HANDSBEHIND_3416, x = 3181, z = 3506, direction = Direction.NORTH, static = true)
spawn_npc(npc = Npcs.BANKER_LATEST_FEMALE_BLOND_HANDSBEHIND_2718, x = 3181, z = 3480, direction = Direction.NORTH, static = true) // Blond female South-East Stall, Facing North
spawn_npc(npc = Npcs.BANKER_LATEST_MALE_HANDSBEHIND_3418, x = 3180, z = 3477, direction = Direction.SOUTH, static = true)
