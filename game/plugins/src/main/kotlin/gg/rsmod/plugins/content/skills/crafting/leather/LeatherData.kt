...
enum class LeatherData(val raw: Int, val products: Array<LeatherItem>) {
    LEATHER(
        raw = Items.LEATHER,
        products = arrayOf(
    ...
    SNAKESKIN(
        raw = Items.SNAKESKIN,
        products = arrayOf(
            LeatherItem(resultItem = Items.SNAKESKIN_BOOTS, amountRequired = 6, levelRequired = 45, experience = 30.0),
            LeatherItem(resultItem = Items.SNAKESKIN_VAMBRACES, amountRequired = 8, levelRequired = 47, experience = 35.0),
            LeatherItem(resultItem = Items.SNAKESKIN_BANDANA, amountRequired = 5, levelRequired = 48, experience = 45.0),
            LeatherItem(resultItem = Items.SNAKESKIN_CHAPS, amountRequired = 12, levelRequired = 51, experience = 50.0),
            LeatherItem(resultItem = Items.SNAKESKIN_BODY, amountRequired = 15, levelRequired = 53, experience = 55.0)
        )
    ),
    YAK_HIDE(
        ...
        products = arrayOf(
            ...
            LeatherItem(resultItem = Items.YAKHIDE_ARMOUR, amountRequired = 2, levelRequired = 46, experience = 32.0)
        )
    ),
    GREEN_DRAGONHIDE(
        ...
        products = arrayOf(
            ...
            LeatherItem(resultItem = Items.GREEN_DHIDE_CHAPS, amountRequired = 2, levelRequired = 60, experience = 124.0),
            LeatherItem(resultItem = Items.GREEN_DHIDE_BODY, amountRequired = 3, levelRequired = 63, experience = 186.0)
        )
    ),
    BLUE_DRAGONHIDE(
        ...
        products = arrayOf(
            ...
            LeatherItem(resultItem = Items.BLUE_DHIDE_CHAPS, amountRequired = 2, levelRequired = 68, experience = 140.0),
            LeatherItem(resultItem = Items.BLUE_DHIDE_BODY, amountRequired = 3, levelRequired = 71, experience = 210.0)
        )
    ),
    RED_DRAGONHIDE(
        ...
        products = arrayOf(
            ...
            LeatherItem(resultItem = Items.RED_DHIDE_CHAPS, amountRequired = 2, levelRequired = 75, experience = 156.0),
            LeatherItem(resultItem = Items.RED_DHIDE_BODY, amountRequired = 3, levelRequired = 77, experience = 234.0)
        )
    ),
    BLACK_DRAGONHIDE(
        ...
        products = arrayOf(
            ...
            LeatherItem(resultItem = Items.BLACK_DHIDE_CHAPS, amountRequired = 2, levelRequired = 82, experience = 172.0),
            LeatherItem(resultItem = Items.BLACK_DHIDE_BODY, amountRequired = 3, levelRequired = 84, experience = 258.0)
        )
    );
