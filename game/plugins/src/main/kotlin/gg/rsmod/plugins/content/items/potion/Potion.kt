...
enum class Potion(
    ...
    WIZARDS_MIND_BOMB(item = Items.WIZARDS_MIND_BOMB, potionType = PotionType.WIZARDS_MIND_BOMB),
    DWARVEN_STOUT(item = Items.DWARVEN_STOUT, potionType = PotionType.DWARVEN_STOUT),
    ASGARNIAN_ALE(item = Items.ASGARNIAN_ALE, potionType = PotionType.ASGARNIAN_ALE),
