...
rawIds.forEach {
    ...
    on_item_on_item(item1 = Items.NEEDLE, item2 = item) {
        ...
        player.queue {
            produceItemBox(*products, option = SkillDialogueOption.MAKE, title = "Choose how many you wish to make,<br>then click on the item to begin.", logic = ::craftLeatherItem)
        }
    }
}
