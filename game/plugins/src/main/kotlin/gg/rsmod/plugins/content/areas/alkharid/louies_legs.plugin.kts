...
create_shop("Louie's Armoured Legs Bazaar", purchasePolicy = PurchasePolicy.BUY_STOCK, currency = CoinCurrency(), containsSamples = false) {
    ...
    player.queue {
        ...
        when(options("What have you got?", "No, thank you.")) {
            1 -> {
                ...
                chatNpc("I provide items to help you keep your legs!", facialExpression = FacialExpression.HAPPY_TALKING)
                player.openShop("Louie's Armoured Legs Bazaar")
            }
