...
val SKILLS_NECKLACE = intArrayOf(
        Items.SKILLS_NECKLACE_1, Items.SKILLS_NECKLACE_2, Items.SKILLS_NECKLACE_3, Items.SKILLS_NECKLACE_4
)
...
fun replacement(original: Int): Int {
    return when (original) {
        in Items.SKILLS_NECKLACE_4..Items.SKILLS_NECKLACE_2 -> original + 2
        else -> -1
    }
}
...
fun message(original: Int): String {
    return when (original) {
        ...
        else -> "Your skills necklace has run out of charges."
    }
}
