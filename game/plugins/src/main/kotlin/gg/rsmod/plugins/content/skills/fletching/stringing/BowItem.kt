...
enum class BowItem(val product: Int, val amount: Int = 1, val levelRequirement: Int, val experience: Double, val itemName: String = "") {
...
//    COMP_OGRE_BOW(product = Items.COMP_OGRE_BOW, levelRequirement = 30, experience = 45.0, itemName = "Unstrung comp bow"),
    ...
    WILLOW_SHORTBOW(product = Items.WILLOW_SHORTBOW, levelRequirement = 35, experience = 33.3, itemName = "Willow shortbow"),
    WILLOW_LONGBOW(product = Items.WILLOW_LONGBOW, levelRequirement = 40, experience = 41.5, itemName = "Willow longbow"),
    ...
    MAPLE_SHORTBOW(product = Items.MAPLE_SHORTBOW, levelRequirement = 50, experience = 50.0, itemName = "Maple shortbow"),
    ...
    MAGIC_SHORTBOW(product = Items.MAGIC_SHORTBOW, levelRequirement = 80, experience = 83.3, itemName = "Magic shortbow"),
