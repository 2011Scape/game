...
val ids = intArrayOf(Npcs.ABERRANT_SPECTRE, Npcs.ABERRANT_SPECTRE_1605, Npcs.ABERRANT_SPECTRE_1607, Npcs.ABERRANT_SPECTRE_7801, Npcs.ABERRANT_SPECTRE_7802
        , Npcs.ABERRANT_SPECTRE_7803, Npcs.ABERRANT_SPECTRE_7804)

val table = DropTableFactory

val aberrantSpectre = table.build {
    main {
        total(512)
